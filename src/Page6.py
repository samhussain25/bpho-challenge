...
####### GRAPH #######
        ...
        def new_line():
            ...
            ax.set_title(str('g='+str(app.g)+'m/s^-2, h='+str(app.h)+'m, u='+str(app.speed)+
                             ...
                             str(round(dinfo[1], 2))+'m'), loc='center', wrap=True)
...
#################################################        
        ...
        self.labelTheta = tk.Label(self, text='theta, degrees', font = NORMALFONT)
        self.labelTheta.grid(column=1, row=2, columnspan=2)
