...
#################################################        
        ...
        self.sliderSpeed = tk.Scale(self, from_=0, to=app.MAXSPEED, orient='horizontal', resolution=0.01,
        ...
        self.sliderTheta = tk.Scale(self, from_=0.1, to=90, orient='horizontal', resolution=0.01,
